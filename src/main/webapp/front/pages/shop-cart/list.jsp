		...
		<div id="app">
			...
			<div class="paper-container">
				...
				<div class="btn-container">
					...
					<button :style='{"padding":"0 10px","boxShadow":"0 0 6px #9d7e62","margin":"0 5px","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","color":"rgba(157, 126, 98, 1)","borderRadius":"4px","borderWidth":"0","width":"auto","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}'  @click="buyClick" type="button" class="layui-btn layui-btn-lg btn-theme">
